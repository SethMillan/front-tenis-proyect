...
const registerSchema = z.object({
  ...
  apellido_p: z.string().min(2, { message: "Debe tener 2 caracteres como minimo" }),
  apellido_m: z.string().min(2, { message: "Debe tener 2 caracteres como minimo" }),
        ...
        <Form {...form}>
            <FormField
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <Input placeholder="Escribe el apellido paterno, ej:Peréz" {...field} />
                    </FormControl>
                    <FormMessage />
                    </FormItem>
                )}
        ...
        <Form {...form}>
            <FormField
                ...
                render={({ field }) => (
                    ...
                    <FormControl>
                        <Input placeholder="Escribe el apellido materno, ej:Martinez" {...field} />
                    </FormControl>
                    <FormMessage />
                    </FormItem>
                )}
